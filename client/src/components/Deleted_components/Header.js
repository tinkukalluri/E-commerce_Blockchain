// this bug took me a lot of time to fix the problem occured dur to wrapping the component into setJumbotronJSX() and updating only when
//     useEffect(() => {
//     jumbotron_maintop()
// }, [props.authResultApp, authResult]) removing this setJumbotronJSX() fixed the bug the renewed code is at the bottom of the file

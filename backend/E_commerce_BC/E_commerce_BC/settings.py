"""
Django settings for E_commerce_BC project.
...
SECRET_KEY = 'django-insecure-w7#4xc_*dw-3ua-tnmt-h#6jev-03yb012#4!%=!nb%nh)1u=s'
...
ROOT_URLCONF = 'E_commerce_BC.urls'
...
WSGI_APPLICATION = 'E_commerce_BC.wsgi.application'

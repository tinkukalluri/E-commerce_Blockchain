...
urlpatterns = [
    ...
    path('add_to_wishlist' ,  views.AddToWishList.as_view()),
    path('remove_from_wishlist' ,  views.RemoveFromWishlist.as_view()),
    path('wishlist_product' ,  views.WishListProducts.as_view()),
